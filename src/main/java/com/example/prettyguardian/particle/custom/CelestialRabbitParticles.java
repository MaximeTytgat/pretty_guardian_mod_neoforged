...
public class CelestialRabbitParticles extends TextureSheetParticle {
    private final double xStart;
    private final double yStart;
    private final double zStart;

    protected CelestialRabbitParticles(ClientLevel clientLevel, double v, double v1, double v2, double v3, double v4, double v5) {
        ...
        this.rCol = 1F;
        this.gCol = 0.7490196078431373F;
        this.bCol = 0.7490196078431373F;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType t, @NotNull ClientLevel clientLevel, double v, double v1, double v2, double v3, double v4, double v5) {
            CelestialRabbitParticles portalparticle = new CelestialRabbitParticles(clientLevel, v, v1, v2, v3, v4, v5);
