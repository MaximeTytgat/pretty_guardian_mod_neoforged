package com.example.prettyguardian.particle.custom;
...
public class PinkFairyParticles extends TextureSheetParticle {
    private final double xStart;
    private final double yStart;
    private final double zStart;

    protected PinkFairyParticles(ClientLevel clientLevel, double v, double v1, double v2, double v3, double v4, double v5) {
    ...
    @Override
    public void move(double v2, double v1, double v) {
        this.setBoundingBox(this.getBoundingBox().move(v2, v1, v));
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType t, @NotNull ClientLevel clientLevel, double v, double v1, double v2, double v3, double v4, double v5) {
            PinkFairyParticles portalparticle = new PinkFairyParticles(clientLevel, v, v1, v2, v3, v4, v5);
