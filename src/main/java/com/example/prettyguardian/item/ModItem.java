...
import com.max.prettyguardian.item.ModFoods;
import com.max.prettyguardian.item.ModToolTiers;
...
public class ModItem {
    ...
    public static final DeferredItem<Item> PISTACHIO_ICE_CREAM = ITEMS.register("pistachio_ice_cream", () -> new ReusableFoodContainerItem(new Item.Properties().food(ModFoods.ICE_CREAM), 32, com.max.prettyguardian.item.PrettyGuardianItem.ICE_CREAM_CUP, false));
    public static final DeferredItem<Item> VANILLA_ICE_CREAM = ITEMS.register("vanilla_ice_cream", () -> new ReusableFoodContainerItem(new Item.Properties().food(ModFoods.ICE_CREAM), 32, com.max.prettyguardian.item.PrettyGuardianItem.ICE_CREAM_CUP, false));
    public static final DeferredItem<Item> CHOCOLATE_ICE_CREAM = ITEMS.register("chocolate_ice_cream", () -> new ReusableFoodContainerItem(new Item.Properties().food(ModFoods.ICE_CREAM), 32, com.max.prettyguardian.item.PrettyGuardianItem.ICE_CREAM_CUP, false));
    public static final DeferredItem<Item> STRAWBERRY_ICE_CREAM = ITEMS.register("strawberry_ice_cream", () -> new ReusableFoodContainerItem(new Item.Properties().food(ModFoods.ICE_CREAM), 32, com.max.prettyguardian.item.PrettyGuardianItem.ICE_CREAM_CUP, false));
    public static final DeferredItem<Item> POKKY_ICE_CREAM = ITEMS.register("pokky_ice_cream", () -> new ReusableFoodContainerItem(new Item.Properties().food(ModFoods.POKKY_ICE_CREAM), 64, com.max.prettyguardian.item.PrettyGuardianItem.ICE_CREAM_CUP, false));
    public static final DeferredItem<Item> APPLE_MOJITO = ITEMS.register("apple_mojito", () -> new ReusableFoodContainerItem(new Item.Properties().food(ModFoods.MOJITO), 32, com.max.prettyguardian.item.PrettyGuardianItem.JUICE_GLASS));
    public static final DeferredItem<Item> MINT_MOJITO = ITEMS.register("mint_mojito", () -> new ReusableFoodContainerItem(new Item.Properties().food(ModFoods.MOJITO), 32, com.max.prettyguardian.item.PrettyGuardianItem.JUICE_GLASS));
    public static final DeferredItem<Item> STRAWBERRY_MOJITO = ITEMS.register("strawberry_mojito", () -> new ReusableFoodContainerItem(new Item.Properties().food(ModFoods.MOJITO), 32, com.max.prettyguardian.item.PrettyGuardianItem.JUICE_GLASS));
    public static final DeferredItem<Item> BUBBLETEA_MELON = ITEMS.register("bubbletea_melon", () -> new ReusableFoodContainerItem(new Item.Properties().food(ModFoods.BUBBLE_TEA), 32, com.max.prettyguardian.item.PrettyGuardianItem.JUICE_GLASS));
    public static final DeferredItem<Item> BUBBLETEA_STRAWBERRY = ITEMS.register("bubbletea_strawberry", () -> new ReusableFoodContainerItem(new Item.Properties().food(ModFoods.BUBBLE_TEA), 32, com.max.prettyguardian.item.PrettyGuardianItem.JUICE_GLASS));
    public static final DeferredItem<Item> BUBBLETEA_CARAMEL = ITEMS.register("bubbletea_caramel", () -> new ReusableFoodContainerItem(new Item.Properties().food(ModFoods.BUBBLE_TEA), 32, com.max.prettyguardian.item.PrettyGuardianItem.JUICE_GLASS));
