...
public class ReusableFoodContainerItem extends Item {
    ...
    private final DeferredItem<Item> reuseItem;

    public ReusableFoodContainerItem(Properties properties, int drinkDuration, DeferredItem<Item> reuseItem) {
        super(properties);
    ...
    public ReusableFoodContainerItem(Properties properties, int drinkDuration, DeferredItem<Item> reuseItem, boolean isDrink) {
        super(properties);
        this.reuseItem = reuseItem;
        this.drinkDuration = drinkDuration;
