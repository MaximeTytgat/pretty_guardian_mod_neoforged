...
import com.example.prettyguardian.item.client.EternalSilverCristalStaffRenderer;
...
public class EternalSilverCristalStaffitem extends BowItem implements GeoItem {
    ...
    public static void setPlayerStaffCooldown(Player player, int cooldown) {
        player.getCooldowns().addCooldown(ModItem.ETERNAL_SILVER_CRISTAL_STAFF.get(), cooldown);
        player.getCooldowns().addCooldown(ModItem.CUTIE_MOON_ROD.get(), cooldown);
        player.getCooldowns().addCooldown(ModItem.ETERNAL_TIARE.get(), cooldown);
        player.getCooldowns().addCooldown(ModItem.MOON_KALEIDOSCOPE.get(), cooldown);
        player.getCooldowns().addCooldown(ModItem.MOON_STICK.get(), cooldown);
        player.getCooldowns().addCooldown(ModItem.MOON_STICK_PEARL.get(), cooldown);
        player.getCooldowns().addCooldown(ModItem.SPIRAL_HEART_MOON_ROD.get(), cooldown);
    }
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level level, Player player, @NotNull InteractionHand interactionHand) {
        ...
        InteractionResultHolder<ItemStack> ret = EventHooks.onArrowNock(itemstack, level, player, interactionHand, flag);
