...
import com.example.prettyguardian.entity.goal.StopMoveWhenOrderedToGoal;
...
public class CelestialRabbitEntity extends TamableAnimal implements FlyingAnimal, NeutralMob {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.3D, Ingredient.of(ModItem.FISH_WAFFLE.get()), false));
    ...
    public boolean isFood(ItemStack itemStack) {
        return itemStack.is(ModItem.FISH_WAFFLE.get());
    }
