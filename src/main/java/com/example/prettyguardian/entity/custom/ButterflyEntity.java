package com.example.prettyguardian.entity.custom;
    ...
    public @NotNull InteractionResult mobInteract(Player player, @NotNull InteractionHand interactionHand) {
        ...
        if (itemstack.getItem() instanceof ButterflyNetItem && !this.isBaby() && !this.level().isClientSide) {
            ...
            ItemStack butterflyEgg = switch (v) {
                case ADMIRAL -> new ItemStack(ModItem.ADMIRAL_BUTTERFLY_EGG.get());
                case APOLLO -> new ItemStack(ModItem.APOLLO_BUTTERFLY_EGG.get());
                case DUSK -> new ItemStack(ModItem.DUSK_BUTTERFLY_EGG.get());
                case LEMON -> new ItemStack(ModItem.LEMON_BUTTERFLY_EGG.get());
                case MORPHO -> new ItemStack(ModItem.MORPHO_BUTTERFLY_EGG.get());
                case ORCHID -> new ItemStack(ModItem.ORCHID_BUTTERFLY_EGG.get());
                case PEACOCK -> new ItemStack(ModItem.PEACOCK_BUTTERFLY_EGG.get());
                case PINK -> new ItemStack(ModItem.PINK_BUTTERFLY_EGG.get());
                case SKIPPER -> new ItemStack(ModItem.SKIPPER_BUTTERFLY_EGG.get());
                case VIOLETTE -> new ItemStack(ModItem.VIOLETTE_BUTTERFLY_EGG.get());
            };
