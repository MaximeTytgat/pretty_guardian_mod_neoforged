...
import com.max.prettyguardian.block.custom.SeaShell;
...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldPinkSapphireOres = List.of(OreConfiguration.target(stoneReplaceabeles,
                        ModBlock.PINK_SAPPHIRE_ORE.get().defaultBlockState()),
                OreConfiguration.target(deepslateReplaceabeles, ModBlock.DEEPSLATE_PINK_SAPPHIRE_ORE.get().defaultBlockState()));
        ...
        List<OreConfiguration.TargetBlockState> overworldRubyOres = List.of(OreConfiguration.target(deepslateReplaceabeles, ModBlock.DEEPSLATE_RUBY_ORE.get().defaultBlockState()));
        ...
        register(context, PISTACHIO_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                ...
                new WeightedStateProvider(weightedBlockStateBuilder()
                        ...
                        .add(ModBlock.PISTACHIO_LEAVES_CROP.get().defaultBlockState(), 1)),
        ...
        register(context, LEMON_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                ...
                new WeightedStateProvider(weightedBlockStateBuilder()
                        .add(Blocks.OAK_LEAVES.defaultBlockState(), 5)
                        .add(ModBlock.LEMON_LEAVES_CROP.get().defaultBlockState(), 1)),
                new BlobFoliagePlacer(ConstantInt.of(3), ConstantInt.of(2), 3),
                new TwoLayersFeatureSize(1, 0, 2)).build());
        ...
        register(context, BOBA_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                ...
                new WeightedStateProvider(weightedBlockStateBuilder()
                        .add(Blocks.OAK_LEAVES.defaultBlockState(), 5)
                        .add(ModBlock.BOBA_LEAVES_CROP.get().defaultBlockState(), 1)),
                new BlobFoliagePlacer(ConstantInt.of(3), ConstantInt.of(2), 3),
                new TwoLayersFeatureSize(1, 0, 2)).build());


        register(context, SEA_SHELL_KEY, Feature.RANDOM_PATCH, seaShell(ModBlock.SEA_SHELL.get(), List.of(Blocks.SAND, Blocks.RED_SAND)));
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(PrettyGuardian.MOD_ID, name));
    }
