package com.max.prettyguardian.block;

import com.max.prettyguardian.item.ModItem;
import com.max.prettyguardian.PrettyGuardian;
import com.max.prettyguardian.block.custom.PicnicBasketBlock;
import com.max.prettyguardian.block.custom.SeaShell;
import com.max.prettyguardian.block.custom.SilverCrystalBlock;
import com.max.prettyguardian.block.custom.crop.CropLeavesBlock;
...
import com.max.prettyguardian.block.custom.crop.VanillaCropBlock;
import com.max.prettyguardian.block.custom.food.BaseCake;
import com.max.prettyguardian.block.custom.food.BasePie;
import com.max.prettyguardian.block.custom.food.BaseThreeCake;
import com.max.prettyguardian.block.custom.furniture.*;
import com.max.prettyguardian.block.custom.plush.CowPlushBlock;
import com.max.prettyguardian.block.custom.plush.PlushiesBlock;
import com.max.prettyguardian.block.custom.plush.RandomPlushBoxBlock;
import com.max.prettyguardian.block.custom.table.GemPolishingStationBlock;
...
import static com.max.prettyguardian.item.ModItem.ITEMS;
