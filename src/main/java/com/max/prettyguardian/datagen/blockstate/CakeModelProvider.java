...
public class CakeModelProvider {
    private CakeModelProvider() {}
    ...
    public static void simpleCake(Block block, ModBlockStateProvider provider) {
        provider.getVariantBuilder(block)
                .partialState().with(BaseCake.BITES, 0).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block))
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block)).element()
                        ...
                        .end()))
                .partialState().with(BaseCake.BITES, 1).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice1")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block)).element()
                        ...
                        .face(Direction.DOWN).uvs(0.5F, 8.5F, 7.5F, 15.5F).texture(TEXTURE_TAG).end()
                        .end()))
                .partialState().with(BaseCake.BITES, 2).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice2")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        ...
                        .end()))
                .partialState().with(BaseCake.BITES, 3).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice3")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        ...
                        .end()))
                .partialState().with(BaseCake.BITES, 4).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice4")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        ...
                        .end()))
                .partialState().with(BaseCake.BITES, 5).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice5")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        ...
                        .end()))
                .partialState().with(BaseCake.BITES, 6).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice6")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
    ...
    public static void simpleThreeCake(Block block, ModBlockStateProvider provider) {
        provider.getVariantBuilder(block)
                .partialState().with(BaseThreeCake.BITES, 0).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block))
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        ...
                        .face(Direction.DOWN).uvs(5.84615F, 11.69231F, 10.15385F, 16F).texture(TEXTURE_TAG).end()
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 1).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice1")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        .from(1, 0, 1).to(15, 8, 15)
                        ...
                        .face(Direction.DOWN).uvs(5.84615F, 11.69231F, 10.15385F, 16F).texture(TEXTURE_TAG).end()
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 2).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice2")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        .from(1, 0, 1).to(15, 8, 15)
                        ...
                        .face(Direction.DOWN).uvs(5.84615F, 11.69231F, 10.15385F, 16F).texture(TEXTURE_TAG).end()
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 3).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice3")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        .from(1, 0, 1).to(15, 8, 15)
                        ...
                        .face(Direction.DOWN).uvs(5.84615F, 11.69231F, 10.15385F, 16F).texture(TEXTURE_TAG).end()
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 4).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice4")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        .from(1, 0, 1).to(15, 8, 15)
                        ...
                        .face(Direction.DOWN).uvs(5.84615F, 11.69231F, 10.15385F, 16F).texture(TEXTURE_TAG).end()
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 5).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice5")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        .from(1, 0, 1).to(15, 8, 15)
                        ...
                        .face(Direction.DOWN).uvs(5.84615F, 11.69231F, 10.15385F, 16F).texture(TEXTURE_TAG).end()
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 6).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice6")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        .from(1, 0, 1).to(15, 8, 15)
                        ...
                        .face(Direction.DOWN).uvs(5.84615F, 11.69231F, 10.15385F, 16F).texture(TEXTURE_TAG).end()
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 7).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice7")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        .from(1, 0, 1).to(15, 8, 15)
                        ...
                        .face(Direction.DOWN).uvs(5.84615F, 11.69231F, 10.15385F, 16F).texture(TEXTURE_TAG).end()
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 8).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice8")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        .from(1, 0, 1).to(15, 8, 15)
                        ...
                        .face(Direction.DOWN).uvs(5.84615F, 11.69231F, 10.15385F, 16F).texture(TEXTURE_TAG).end()
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 9).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice9")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        .from(1, 0, 1).to(15, 8, 15)
                        ...
                        .face(Direction.DOWN).uvs(5.84615F, 11.69231F, 10.15385F, 16F).texture(TEXTURE_TAG).end()
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 10).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice10")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        .from(1, 0, 1).to(15, 8, 15)
                        ...
                        .face(Direction.DOWN).uvs(0.92308F, 11.69231F, 5.23077F, 16F).texture(TEXTURE_TAG).end()
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 11).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice11")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        ...
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 12).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice12")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        ...
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 13).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice13")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        ...
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 14).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice14")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
                        ...
                        .end()))
                .partialState().with(BaseThreeCake.BITES, 15).addModels(new ConfiguredModel(provider.models().getBuilder(provider.getBlockPath(block) + "_slice15")
                        .texture(TEXTURE_KEY, provider.blockTexture(block))
                        .texture(PARTICLE_KEY, provider.blockTexture(block))
                        .element()
